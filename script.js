document.addEventListener("DOMContentLoaded", function () {
    ...
    function sendFormData() {
        ...
        emailjs.sendForm('service_wws412t', 'template_38gdl8b', formData, 'y7iBeg1e0KKK0zwYJ')
        ...
        emailjs.sendForm('service_wws412t', 'template_rg2ueqq', formData, 'y7iBeg1e0KKK0zwYJ')
            .then(function (response) {
